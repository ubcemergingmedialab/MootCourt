...
const defaultQuestions = [["Would you not agree that being a server in a restaurant is very hard work and that these persons deserve more than the minimum wage they are usually paid by restaurants?",
    ...
    "Does this policy not simplify the whole restaurant experience because the customer is just presented with a final bill they can pay with a quick tap?"], ["Does this new policy take away any incentive of the server to provide excellent service?",
